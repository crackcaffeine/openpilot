...
def create_steering_control(apply_steer, car_fingerprint, idx):
  ...
  if car_fingerprint in (CAR.CRV, CAR.ACURA_RDX):
    ...
    if CAR.CIVIC_HATCH:
      commands.append(make_can_msg(0xe4, msg_0xe4, idx, 2))
    else:
...
def create_ui_commands(pcm_speed, hud, car_fingerprint, idx):
  ...
  if CAR.CIVIC_HATCH:
    commands.append(make_can_msg(0x33d, msg_0x33d, idx, 2))
  else:
...
def create_cancel_command(idx):
  ...
  commands.append(make_can_msg(0x296, msg_0x296, idx, 0))
  """ACC Control"""
  #msg_0x1df = "\x8a\xd0\x01\x00\x00\x00\x00"
  #commands.append(make_can_msg(0x1df, msg_0x1df, idx, 0))
  """ACC_CONTROL_ON"""
  #msg_0x1ef = "\x03\xff\x00\x75\x30\x00\x00"
  #commands.append(make_can_msg(0x1ef, msg_0x1ef, idx, 0))
  return commands
